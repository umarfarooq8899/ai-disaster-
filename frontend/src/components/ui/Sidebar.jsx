...
const NavItem = ({ to, exact = false, children }) => {
      ...
      <nav className="flex-1 px-3 pb-6 overflow-y-auto">
        ...
        {role === "volunteer" && (
          <>
            ...
            <NavItem to="/dashboard/volunteer" exact>Overview</NavItem>
        ...
        {role === "ngo" && (
          <>
            ...
            <NavItem to="/dashboard/ngo" exact>Overview</NavItem>
            <NavItem to="/dashboard/ngo/volunteers">
              Manage Volunteers
            </NavItem>
          </>
        )}
        ...
        {isRescue && (
          <>
            ...
            <NavItem to="/dashboard/rescue" exact>Home</NavItem>
            <NavItem to="/dashboard/rescue/dashboard">Dashboard</NavItem>
            <NavItem to="/dashboard/rescue/missions">Missions</NavItem>
            <NavItem to="/dashboard/rescue/missions/new">
              Create Mission
            </NavItem>
          </>
        )}
        ...
        {role === "admin" && (
          <>
            ...
            <NavItem to="/dashboard/admin" exact>Admin Panel</NavItem>

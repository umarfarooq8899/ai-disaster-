            ...
            {missions.length === 0 ? (
                ...
                <div className="grid grid-cols-1 gap-6">
                    {missions.map((mission) => (
                        <div
                            key={mission._id}
                            className="bg-white rounded-xl p-6 shadow-sm border flex flex-col md:flex-row justify-between items-start gap-4"
                        >
                            <div className="flex-1">
                                ...
                                {mission.assignedVolunteers && mission.assignedVolunteers.length > 0 && (
                                    <p className="text-xs text-gray-400 mt-2">
                                        Volunteers involved: {mission.assignedVolunteers.length}
                                    </p>
                                )}
                            </div>
                        </div>

...
const AIDashboard = () => {
    ...
    const handleSendSMSWarning = async () => {
        if (!currentLive || currentLive.risk === 'low') return;
        
        try {
            // Pick properties for the disaster from currentLive
            // Some AI tabs have threatZones
            ...
            alert('AI Alert generated and broadcasted successfully!');
        } catch (err) {
